...
<body
	style="background-image: url(https://images.pexels.com/photos/62693/pexels-photo-62693.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1); background-size: cover; background-repeat: no-repeat;">

	<header class="site-header" id="header">
		<h1 class="site-header__title" data-lead-id="site-header-title">EMAIL
			SENT SUCCESFULLY!!</h1>
	</header>
	<div class="main-content"></div>
	<div class="buttonzs">
		<button>
			<a style="text-decoration: none; color: white;" href="dashboard">DASHBOARD
		</button>
		</a>
</body>
</html>