		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				...
				<div class="card-body">
					<form>
						<div>
							<button style="margin-left: 38%"
								; class="btn btn--radius-2 btn--red" type="button">
								<a style="color: white; text-decoration: none;" href="register">
									Add User 
							</button>
							</a> <br> <br>
							<button style="margin-left: 36.5%"
								; class="btn btn--radius-2 btn--red" type="button">
								<a style="color: white; text-decoration: none;" href="search">
									Search User 
							</button>
							</a> <br> <br>
							<button style="margin-left: 35.5%"
								; class="btn btn--radius-2 btn--red" type="button">
								<a style="color: white; text-decoration: none;" href="show">
									Show All User 
							</button>
							</a> <br> <br>
							<button style="margin-left: 34.5%"
								; class="btn btn--radius-2 btn--red" type="button">
								<a style="color: white; text-decoration: none;"
									href="deleteUser"> Delete User By ID 
							</button>
							</a>
						</div>
					</form>
