...
<%
Random r = new Random();
int contributions = r.nextInt(12) + 100;
int Following =  r.nextInt(100) + 100;
int Follower = r.nextInt(100) + 100;
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="profile-card">
		...
		<div class="card-header">
			...
			<div class="name">${udata.first_name}${udata.last_name }</div>
			<div class="desc">${udata.email }</div>
			<div class="sm">
			...
			<a href="update/${udata.userid}" class="contact-btn">Update
				Profile</a>
		</div>
