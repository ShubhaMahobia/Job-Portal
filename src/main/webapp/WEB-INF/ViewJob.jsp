	...
	<dd:forEach var="showJobs" items="${showJobs}">
		<div class="profile-card" style="margin-right: 20px;">
			...
			<div class="card-header">
				...
				<a href="/jobDetails/${showJobs.job_Id}" class="contact-btn">Job
					Details</a> <a href="/deletejob/${showJobs.job_Id}" class="contact-btn">Delete</a>
			</div>
			<div style="height: 100px; margin-right: 20px; padding: 15px 10px;"
				class="card-footer">
				<div class="numbers">
					<div class="item">
